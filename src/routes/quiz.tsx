  ...
  if (!isSignedIn) {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4">
        <p className="text-[var(--text-secondary)]">Please sign in to start quiz</p>
    ...
    return (
      <div className="mx-auto max-w-2xl px-6 py-12">
        <div className="border border-[var(--border-visible)] bg-[var(--surface)] py-16 text-center">
          <div className="mb-4 flex h-16 w-16 items-center justify-center border border-[var(--border-visible)] bg-[var(--surface-raised)] mx-auto">
          ...
          <p className="mt-2 max-w-sm mx-auto text-[var(--text-secondary)]">
  ...
  const ratings = [
    {
      ...
      className: "border-[var(--accent)] bg-[var(--accent-subtle)] text-[var(--accent)] hover:bg-[var(--accent)]/20",
    },
    {
      value: 2,
      label: "HARD",
    ...
    },
    {
      ...
      className: "border-[var(--good)] bg-[var(--good)]/10 text-[var(--good)] hover:bg-[var(--good)]/20",
    },
    {
      value: 5,
      label: "EASY",
      description: "Perfect recall",
      className: "border-[var(--easy)] bg-[var(--easy)]/10 text-[var(--easy)] hover:bg-[var(--easy)]/20",
    },
  ]
      ...
      <div className="border border-[var(--border)] bg-[var(--surface)]">
        <div className="border-b border-[var(--border)] px-8 py-6">
          ...
          {currentWord.pronunciation && (
            <p className="mt-2 text-[var(--text-secondary)] font-mono">
              {currentWord.pronunciation}
            </p>
          )}
        </div>
        ...
        <div className="px-8 py-8">
          {!showDefinition ? (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <Button variant="secondary" size="lg" onClick={() => setShowDefinition(true)}>
                SHOW DEFINITION
              </Button>
            </div>
          ) : (
            <>
              <div className="space-y-6 border-b border-[var(--border)] pb-6">
                <div>
                  <div className="font-mono text-[11px] uppercase tracking-[0.08em] text-[var(--text-secondary)] mb-2">
                    DEFINITION
                  </div>
              ...
              <div className="pt-6">
                <div className="font-mono text-[11px] uppercase tracking-[0.08em] text-[var(--text-secondary)] mb-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {ratings.map((rating) => (
                    <button
                      ...
                      className={`border flex flex-col items-start px-4 py-3 text-left transition-colors disabled:opacity-50 ${rating.className}`}
                    >
                      <span className="font-mono text-sm font-medium">{rating.label}</span>
              ...
              <button
                ...
                className="mt-4 flex items-center gap-1 text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors"
              >
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.427a3 3 0 114.243 4.243M9.878 9.878l4.242-4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                </svg>
                Hide definition
              </button>
            </>
